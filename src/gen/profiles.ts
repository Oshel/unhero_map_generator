...
export const SUBBIOME_PROFILES: SubbiomeProfile[] = [
  {
    ...
    styleWeights: { corridors: 3, rooms_in_room: 3, organic: 2, pillars: 1, open: 1, symmetric: 1 },
  ...
  },
  {
    ...
    styleWeights: { corridors: 6, rooms_in_room: 3, organic: 1 },
  ...
  },
  {
    ...
    claustrophobia: [5, 35],
    styleWeights: { open: 3, pillars: 3, rooms_in_room: 2, symmetric: 2 },
  ...
  },
  {
    ...
    styleWeights: { organic: 6, corridors: 2, open: 1 },
